      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          {interviews.map((interview) => (
            ...
            >
              <div
                className={`relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 ${interview.bgHover} overflow-hidden`}
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${interview.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-sm animate-rotate-border`}
                ></div>
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className={`flex items-center bg-gradient-to-r ${interview.color} text-white px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-110`}
                  >
        ...
        >
          <div className="relative z-10">
            <h3 className="text-2xl font-bold text-yellow-400 mb-4">
              About Our Media Presence
            </h3>
            <p className="text-gray-200 leading-relaxed">
              Our team regularly appears in interviews, conferences, and media events to share insights on financial literacy, investment strategies, and the importance of financial education.
            </p>
          </div>
