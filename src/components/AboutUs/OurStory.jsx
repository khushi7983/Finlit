...
//       {/* Background SVG (optional, remove if not used) */}
//       <div className="absolute inset-0 opacity-20 pointer-events-none z-0">
//         <img
//           src="/your-background-design.svg"
//           alt="bg-pattern"
...
//           <div className="text-2xl md:text-3xl font-semibold text-indigo-800 leading-relaxed">
//             <Typewriter
//               words={[
