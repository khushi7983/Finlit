...
const FinLitStory = () => {
  ...
  return (
    <section
      id="about-us"
      className="relative bg-gradient-to-br from-white via-gray-100 to-[#c7ba80] py-16 md:py-24 px-6 md:px-12 overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className="space-y-6">
            <div className="inline-block py-2 rounded-full text-sm font-semibold mb-4"></div>
