              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-slate-200">
                <div className="aspect-square bg-gradient-to-br from-slate-100 to-slate-200 rounded-2xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-slate-600 font-medium">Investment Growth</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="prose prose-lg text-slate-600 max-w-none">
              <p className="text-xl leading-relaxed mb-6">
                Financial investing is the act of allocating money to assets with the expectation of generating income or profit over time. 
                It involves purchasing assets like stocks, bonds, real estate, or mutual funds to build wealth.
              </p>
              <p className="text-lg leading-relaxed text-slate-600">
                Investing is a key component of financial planning, enabling you to grow your savings and achieve long-term financial goals. 
                With the right knowledge, anyone can start investing, no matter their experience level.
              </p>
            </div>
