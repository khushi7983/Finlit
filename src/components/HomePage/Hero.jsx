        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              {/* Enhanced CTAs */}
              <motion.div
                className={`flex flex-col sm:flex-row lg:justify-start justify-center gap-4 transition-all duration-1000 ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                }`}
              ...
              >
                {[
                  ...
                  <a
                    key={index}
                    href={button.href}
                    className="group relative bg-gradient-to-r from-slate-800 to-slate-900 text-white px-8 py-4 rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 overflow-hidden transform hover:-translate-y-1"
                    style={{
                      animation: isVisible ? `slide-up 0.8s ease-out ${2.2 + index * 0.2}s both` : "none",
                    }}
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${button.gradient} opacity-0 group-hover:opacity-100 transition-all duration-500`}
                    ></div>
                    <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                    <div className="relative flex items-center gap-2">
                      <button.icon className="w-5 h-5 group-hover:animate-bounce" />
                      {button.text}
                    </div>
                  </a>
                ))}
